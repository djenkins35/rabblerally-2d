...
void Debug::add_b2World(b2World* world)
{
	std::cout << "Debug::add_b2World, world added\n";
	_pWorld = world;
	_pWorld->SetDebugDraw(&_draw);
}

void Debug::debug_tick()
{
	Uint8 *keystate;
...
bool Debug::init_SDL()
{
	...
	*/
	...
	{
		//std::cout << "Debug::init_SDL(), SDL_GetError(): " << SDL_GetError() << std::endl;
		return false;
	}
...
bool Debug::init_opengl()
{
	...
	if (SDL_SetVideoMode(640, 480, 0, SDL_OPENGL) == NULL) {
		...
		//printf("Error: %s\n", SDL_GetError());
		//exit(EXIT_FAILURE);
		std::cout << "Debug::init_opengl(), SDL_GetError(): " << SDL_GetError() << std::endl;
		return false;
	}
